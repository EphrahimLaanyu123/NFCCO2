  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div>
        ...
        <input placeholder="content.." onChange={(e) => setNewArticleContent9 ((e.target.value))} />
        <input placeholder="date.." onChange={(e) => setNewArticleContent9 (Number(e.target.value))} />
        <input type="checkbox" />
