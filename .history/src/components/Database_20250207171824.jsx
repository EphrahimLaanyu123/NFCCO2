  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div>
        ...
        <input placeholder="content.." onChange={(e) => setNewArticleContent (e.target.value)} />
        <input placeholder="date.." onChange={(e) => setNewArticleDate (Number(e.target.value))} />
        <input           
            type="checkbox"
            checked={isApproved}
            onChange={(e) => setIsAprroved(e.target.checked)}  />
        <label>Approved?</label>
        <button onClick={onSubmitArticle}>Submit article</button>
      </div>
