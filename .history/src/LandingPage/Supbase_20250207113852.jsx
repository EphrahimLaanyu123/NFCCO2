    ...
    <div>
      ...
      <ul>
        {suggestedArticles.map((article) => (
          <li key={article.id}>
            ...
            {article.image && (
              <img
                src={`https://YOUR_SUPABASE_BUCKET.supabase.co/storage/v1/object/public/${article.image}`} // Correct image URL
                alt={article.title}
                width="200"
              />
            )}
      ...
      <form onSubmit={handleSubmit}>
        ...
        <textarea
          ...
          required
        />
        <textarea type="text" name="image" onChange={handleImageChange} />
