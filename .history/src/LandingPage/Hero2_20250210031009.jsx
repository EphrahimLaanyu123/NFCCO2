    ...
    <div>
      ...
      <div className="carousel" ref={carouselDom}>
        ...
        <div className="thumbnail" ref={thumbnailBorderDom}>
          <div className="item">
            <img src={Image[0]} alt="Thumbnail 1" />
            <div className="content">
          ...
          <div className="item">
            <img src={Image[1]} alt="Thumbnail 2" />
            <div className="content">
              {/* <div className="thumb-title">Name Slider</div>
              <div className="thumb-description">Description</div> */}
            </div>
          ...
          <div className="item">
            <img src={Image[2]}alt="Thumbnail 3" />
            <div className="content">
              {/* <div className="thumb-title">Name Slider</div>
              <div className="thumb-description">Description</div> */}
            </div>
          ...
          <div className="item">
            <img src={Image[3]} alt="Thumbnail 4" />
            <div className="content">
              {/* <div className="thumb-title">Name Slider</div>
              <div className="thumb-description">Description</div> */}
            </div>
