      ...
      <div className="carousel" ref={carouselDom}>
        ...
        <div className="list" ref={SliderDom}>
          {['image1', 'image2', 'image3', 'image4'].map((imageKey, index) => (
            <div className="item" key={index}>
              {images[imageKey] && (
                <img src={`data:image/jpeg;base64,${images[imageKey].file_data}`} alt={`Slide ${index + 1}`} />
              )}
        ...
        <div className="thumbnail" ref={thumbnailBorderDom}>
          {['image1', 'image2', 'image3', 'image4'].map((imageKey, index) => (
            <div className="item" key={index}>
              {images[imageKey] && (
                <img src={`data:image/jpeg;base64,${images[imageKey].file_data}`} alt={`Thumbnail ${index + 1}`} />
              )}
              <div className="content">
