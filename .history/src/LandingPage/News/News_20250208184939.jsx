    ...
    return (
        <div className="wrapper">
            ...
            <div className="container">
                ...
                <label htmlFor="lion" className="card card1" data-bg="https://ik.imagekit.io/fcuzgktdi/assets/pexels-bisakha-datta-3429431-5598439.jpg?updatedAt=1739005048101">
                    <div className="row">
