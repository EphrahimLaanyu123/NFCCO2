...
const Admin = () => {
    ...
    const fetchSuggestedArticles = async () => {
        try {
            ...
            setSuggestedArticles(response.data.suggested_articles || []); // Handle potential null/undefined
        } catch (err) {
    ...
    const fetchApprovedArticles = async () => {
        try {
            const response = await axios.get('https://nffco-backend.onrender.com/articles'); // Corrected URL
            setApprovedArticles(response.data.articles || []); // Handle potential null/undefined
        } catch (err) {
                        ...
                        {suggestedArticles.map((article) => (
                            <div key={article.id} className="border rounded-lg p-4 shadow">
                                ...
                                <div className="flex space-x-2">
                                    ...
                                    <button
                                        onClick={() => handleApproval(article.id, 'reject')}
