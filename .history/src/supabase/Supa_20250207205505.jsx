  ...
  return (
    <div className="app-container">
      ...
      <div className="input-area">
        ...
        <DatePicker
          selected={newArticle.created_at ? new Date(newArticle.created_at) : null}
            ...
            <li key={article?.id || crypto.randomUUID()} className="article-item">
              {isEditing && articleToEdit?.id === article.id ? ( // Edit mode for this article
                <div>
                  ...
                  />
                  <DatePicker
                    selected={editInputs.created_at ? new Date(editInputs.created_at) : null}
                    onChange={(date) => handleEditInputChange({ target: { name: 'created_at', value: date } })}
