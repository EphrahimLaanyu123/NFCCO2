...
export default function Description() {
  ...
  <div className="aboutus-bottom-content">
    ...
    {/* <div className="aboutus-paragraph">
      <h2>Our Impact</h2>
      <p>
        Over the past decade, we have planted more than 100,000 trees, restored vital ecosystems, and educated thousands 
        of community members on sustainable land management practices. Through these efforts, we've witnessed the resurgence 
        of native wildlife, increased agricultural productivity, and the empowerment of communities to be active stewards 
        of their environment. Our journey is ongoing, and we remain steadfast in our dedication to creating a greener, healthier future.
      </p>
    </div> */}
  </div>
</section>
