...
import Background from '/home/user/nfcco/src/assets/AboutPage/Immersive, fascinating wildlife adventures in the….jpeg';
...
export default function Section() {
  ...
  return (
    <div
      ref={container}
      className="relative flex items-center justify-center h-[] overflow-hidden"
