...
import Background from '/home/user/nfcco/src/assets/AboutPage/8 DAY KENYA TRIP - Tour de Lust.jpeg';
...
export default function Section() {
  ...
  return (
    <div
      ref={container}
      className="relative flex items-center justify-center h-100 overflow-hidden"
