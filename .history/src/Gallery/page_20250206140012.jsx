...
const projects = [
  ...
  },
  {
    ...
    handle2: "ttps://ik.imagekit.io/fcuzgktdi/assets/pexels-thu-trang-1190570-2265090.jpg?updatedAt=1735723648876"
  },
  {
    name: "Landon Speers",
    ...
    <main onMouseMove={mouseMove} className={styles.main}>
      {
        projects.map(({ handle, handle2 }, i) => {
          return <Gallery mousePosition={mousePosition} handle={handle} handle2={handle2} key={i} />;
        })
      }
