export const projects = [
  ...
  },
  {
    ...
    description: "Replanting indigenous trees to restore forest cover, maintain natural habitats, and encourage tourism activities.",
    src: "path-to-image3.jpg",
    color: "#8ECAE6"
  },
  {
    title: "Alternative Building Materials",
    description: "Introducing technology to reduce dependence on unsustainable wood products by using compressed soil-cement bricks.",
    src: "path-to-image4.jpg",
    color: "#023047"
  },
  {
    title: "Efficient Cooking Stoves - Maasai Stoves",
    description: "Providing efficient wood stoves and solar technologies to reduce deforestation and indoor air pollution.",
  ...
  {
    title: "Beekeeping",
    description: "Introducing beekeeping to conserve forests, plant indigenous trees, and provide income through honey sales.",
    src: "path-to-image7.jpg",
    color: "#FF9E00"
  },
  {
    title: "Farming and Processing of Fruit Trees",
    description: "Planting and processing fruit trees to produce juice and jams, improving community financial status and vegetation cover.",
    src: "path-to-image8.jpg",
    color: "#06D6A0"
  },
  {
    title: "Tree Nursery Development",
    description: "Developing tree nurseries to supply indigenous and exotic trees for schools, homesteads, and degraded areas.",
