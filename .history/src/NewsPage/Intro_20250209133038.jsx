...
import { createClient } from 'contentful'; // You can use the same client as before
    ...
    <div className="news-main h-screen overflow-hidden relative" ref={container}>
      <motion.div style={{ y }} className="relative h-full">
        <div className="about-us-page">
          <h1>TRANSFORMING NDOTO</h1>
          <p>ONE TREE AT A TIME</p>

          {/* Latest Article Section */}
          {latestArticle && (
            <section className="latest-article my-10">
          ...
          {otherArticles.length > 0 && (
            <section className="other-articles my-10">
