...
export default function Intro() {
  ...
  return (
    <div className="custom-news-container full-height overflow-hidden relative-container" ref={container}>
        ...
        <div className="custom-about-us-container">
          ...
          {latestArticle && (
            <section className="custom-latest-article article-section">
              <h2 className="custom-section-title">Latest Article</h2>
              <div className="custom-article-card">
                <div className="custom-article-content article-content">
                  <h3 className="custom-article-title">{latestArticle.fields.blogTitle}</h3>
            ...
            <section className="custom-other-articles article-section">
              ...
              <div className="custom-articles-container">
                {otherArticles.map((article) => (
                  <div key={article.sys.id} className="custom-article-card">
                    {article.fields.coverImage?.fields?.file?.url && (
                      <img
                        ...
                        className="custom-article-img article-img"
                      />
                    )}
                    <div className="custom-article-content article-content">
